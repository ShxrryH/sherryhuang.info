...
const projects = [
  ...
  },
  {
    ...
    description: "A bold, dynamic and energetic brand identity built for the next generation of online shoppers.",
    thumbnail: "/aura-1.png",
    tagline: "Aura Brand Identity is a brand design project crafted for an imagined e-commerce brand aimed at supporting teenagers, students and young adults by promoting self-love, self-improvement, and confidence. The project encompassed full brand development from conceptual positioning to visual execution: defining the brands core values and target audience; creating a distinctive logo and visual identity; selecting a compelling color palette and typographic system; and designing branded materials suitable for both digital and physical presence (e.g. packaging or mockups). The result is a cohesive, modern, and youthful brand aesthetic that resonates with the lifestyle and aspirations of a student-age demographic. The identity is friendly yet aspirational tone, combined with clean visuals, makes Auras branding well-suited for a contemporary e-commerce experience.",
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Hi, I'm Sherry Huang — a passionate graphic designer dedicated to crafting visual stories that 
                  connect and inspire. With a keen eye for detail and a love for clean, impactful design, 
                  I specialize in brand identity, digital design, and creative storytelling. My work blends 
                  strategic thinking with artistic expression to create meaningful experiences that resonate 
                  with audiences. I believe great design isn't just about aesthetics—it's about solving 
                  problems and creating connections that last.
                </p>
